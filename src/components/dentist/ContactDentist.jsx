              ...
              >
                <div className="bg-card p-8 rounded-lg shadow-xl">
                  ...
                  <div className="space-y-4 text-muted-foreground">
                    ...
                    <p className="flex items-center"><Phone size={20} className="mr-3 text-primary flex-shrink-0" /> <a href="tel:+40722000000" className="hover:text-primary transition-colors">{t('dentistContactPhoneNumber', { defaultText: "0722 000 000" })}</a></p>
                    <p className="flex items-center"><Mail size={20} className="mr-3 text-primary flex-shrink-0" /> <a href="mailto:contact@dentalcare.ro" className="hover:text-primary transition-colors">{t('dentistContactEmailAddress', { defaultText: "contact@dentalcare.ro" })}</a></p>
                  </div>
                ...
                <div className="bg-card h-72 rounded-lg shadow-xl overflow-hidden">
                   <iframe 
                    ...
                    title={t('dentistContactMapTitle', { defaultText: "Locația Clinicii DentalCare"})}
                    loading="lazy"
